...
(* OASIS_START *)
(* DO NOT EDIT (digest: 99876ed6fd0a01c9fbfc34d668fe421a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Anil Madhavapeddy"; "Daniel C. B\195\188nzli"; "Matthew Gray"];
          homepage = None;
          bugreports = None;
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pclock"; "Mclock"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-clock-unix";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage-clock-xen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-clock-xen";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\251\173q\218+\017\211\019\175\147a]\252\206(\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
